...
generate_thread() {
  ...
  clear && display_header
    ...
    if [ ! -z "$manufacturer_name" ]; then
        ...
        while true; do
            branches=($(curl -s "https://api.github.com/repos/Evolution-XYZ/manifest/branches" | jq -r '.[].name'))
            ...
            raw_manifest_url="https://raw.githubusercontent.com/Evolution-XYZ/manifest/$selected_branch/default.xml"
            xml_data=$(curl -s "$raw_manifest_url")
            tree_url="https://github.com/Evolution-XYZ/manifest/tree/$selected_branch"
            ...
            if [[ ! -z "$xml_data" ]]; then
                ...
                if [[ ! -z "$android_version" ]]; then
                    ...
                    blob_manifest_url="https://github.com/Evolution-XYZ/manifest/blob/$selected_branch/"
                    break
                else
...
[IMG]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/$banner_image[/IMG]
...
[IMG]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/features.png[/IMG]

[URL='https://github.com/Evolution-XYZ/XDA/blob/udc/features.md']Added features[/URL]

[IMG]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/known_issues.png[/IMG]

[SIZE=5][B][COLOR=red]DO NOT FLASH GAPPS, THEY ARE ALREADY INCLUDED[/COLOR][/B][/SIZE]

[B][IMG]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/installation.png[/IMG][/B]
...
[URL='$donation_url'][IMG width="200px" height="180px"]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/donate_to_me.png[/IMG][/URL][URL='https://discord.gg/3qbSZHx'][IMG width="200px" height="180px"]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/official_chat.png[/IMG][/URL][URL='$device_support_url'][IMG width="200px" height="180px"]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/device_support.png[/IMG][/URL][/CENTER]

[TABLE]
[TR]
[TD][IMG]https://raw.githubusercontent.com/Evolution-XYZ/XDA/udc/assets/source.png[/IMG][/TD]
[/TR]
[TR]
...
[/TR]
[TR]
[TD][B][COLOR=rgb(97, 189, 109)]Source code[/COLOR]:[/B] [URL]https://github.com/Evolution-XYZ[/URL][/TD]
[/TR]
[/TABLE]
[CENTER][/CENTER]
EOF
